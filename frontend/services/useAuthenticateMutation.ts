...
export async function authenticate(args: MutationAuthenticateArgs) {
  return await graphqlClient.request<Mutation, MutationAuthenticateArgs>(AUTHENTICATE_MUTTATION, args)
}

export function useAuthenticateMutation() {
  return useMutation<Mutation, unknown, MutationAuthenticateArgs>({
