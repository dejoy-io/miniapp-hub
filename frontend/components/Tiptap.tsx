...
const Tiptap = (props: TiptapProps) => {
      ...
      if (instant) {
        editor
          ...
          .setLink({
            ...
            href: null,
            onclick: `window.Telegram.MiniApp.openLink('${url}', true); return false;`,
            target: null,
            rel: null,
            class: 'instant',
          })
  ...
  return (
    <>
      {editor && (
        <BubbleMenu editor={editor} tippyOptions={{ duration: 100, zIndex: 10 }}>
          <Button
            size="sm"
          ...
          <Button size="sm" onClick={openSetLinkModal} color={editor.isActive('link') ? 'primary' : 'default'}>
            setLink
          </Button>
          <Button
            size="sm"
      ...
      <SetLinkModal isOpen={isOpen} onOpenChange={onOpenChange} onLinkSet={setLink} />
    </>
  )
}
